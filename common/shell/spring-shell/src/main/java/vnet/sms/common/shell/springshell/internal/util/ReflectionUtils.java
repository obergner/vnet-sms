...
public abstract class ReflectionUtils {
	 ...
	 */
	public static void setField(final Field field, final Object target,
	        final Object value) {
		try {
	 ...
	 */
	public static Object invokeJdbcMethod(final Method method,
	        final Object target) throws SQLException {
	 ...
	 */
	public static Object invokeJdbcMethod(final Method method,
	        final Object target, final Object[] args) throws SQLException {
		try {
			return method.invoke(target, args);
		} catch (final IllegalAccessException ex) {
			handleReflectionException(ex);
	 ...
	 */
	public static void doWithMethods(final Class<?> targetClass,
	        final MethodCallback mc) throws IllegalArgumentException {
	 ...
	 */
	public static void doWithFields(final Class<?> targetClass,
	        final FieldCallback fc) throws IllegalArgumentException {
	...
	public static void doWithFields(Class<?> targetClass,
	        final FieldCallback fc, final FieldFilter ff)
	        throws IllegalArgumentException {
		// Keep backing up the inheritance hierarchy.
		do {
