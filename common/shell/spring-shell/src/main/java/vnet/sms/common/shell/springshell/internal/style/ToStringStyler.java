 ...
 * Encapsulates the print algorithms; some other object such as a builder should
...
public interface ToStringStyler {
	 ...
	 * @param obj
	 *            the object to style; can be <code>null</code>
	 */
	 ...
	 * @param value
	 *            the field value; can be <code>null</code>
	 */
