...
import vnet.sms.common.shell.springshell.internal.ant.AntPathMatcher;
import vnet.sms.common.shell.springshell.internal.ant.PathMatcher;
...
public final class FileUtils {
	 ...
	 * 
	 * @param path
	 *            the path to modify (can be <code>null</code>)
	 ...
	 * 
	 * @param antPattern
	 *            the pattern to check against (can't be blank)
	 * @param canonicalPath
	 ...
	 * 
	 * @param path
	 *            the path to modify (can't be <code>null</code>)
	 ...
	 * 
	 * @param file
	 *            the file for which to find the canonical path (can be
	 *            <code>null</code>)
	 ...
	 * 
	 * @param loadingClass
	 *            the class to whose package the given file is relative
	 *            (required)
	 ...
	 * @param filename
	 *            the name of the file to load, relative to that package
	 *            (required)
