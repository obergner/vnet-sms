...
/**
 * {@link Converter} for {@link Locale}. Supports locales with ISO-639 (ie 'en')
 * or a combination of ISO-639 and ISO-3166 (ie 'en_AU').
 * 
...
public class LocaleConverter implements Converter<Locale> {
	...
	@Override
	public Locale convertFromText(final String value,
	        final Class<?> requiredType, final String optionContext) {
		if (value.length() == 2) {
			// In case only a simpele ISO-639 code is provided we use that code
			// also for the country (ie 'de_DE')
