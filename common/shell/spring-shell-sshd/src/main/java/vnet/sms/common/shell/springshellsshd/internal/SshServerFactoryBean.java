...
import vnet.sms.common.shell.springshellsshd.Defaults;
...
public class SshServerFactoryBean implements FactoryBean<SshServer>,
        JLineShellComponentFactoryAware, InitializingBean, DisposableBean {
	...
	private JLineShellLauncherCommand.Factory	shellFactory;
	...
	@Override
	public void setJLineShellComponentFactory(
	        final JLineShellComponentFactory shellFactory) {
		notNull(shellFactory, "Argument 'shellFactory' must not be null");
		this.shellFactory = new JLineShellLauncherCommand.Factory(shellFactory);
	}
