 ...
 * 
 * @author Markus
 * @version $Id: SmsPduUtilTest.java 410 2006-03-13 19:48:31Z c95men $
 */

public class SmsPduUtilTest extends TestCase {
	public void testSeptetEncoderBitLength() {
		final byte[] srcData = StringUtil.hexStringToBytes("FFFFFFFFFFFFFFFF");
		byte[] dstData;
	...
	public void testSeptetEncoderDstStart() {
		final byte[] srcData = StringUtil.hexStringToBytes("FFFF");
		byte[] dstData;
