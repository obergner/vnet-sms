 ...
 * 
 */
public class ReceivedPingRequestAcknowledgementEvent<ID extends Serializable>
        extends UpstreamWindowedMessageEvent<ID, PingResponse> {
	...
	public ReceivedPingRequestAcknowledgementEvent(final ID messageReference,
		...
		super(messageReference,
		        MessageEventType.RECEIVED_PING_REQUEST_ACKNOWLEDGEMENT,
